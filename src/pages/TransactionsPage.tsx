  ...
  return (
    <div className="space-y-5 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="page-subtitle">
            {filtered.length} entries · {FILTER_LABELS[activeFilter]}
          </p>
        </div>
        <button
      ...
      <div className="flex flex-wrap gap-2">
        {(Object.keys(FILTER_LABELS) as DateFilter[])
          .filter((f) => f !== "custom")
          .map((f) => (
            <button
              key={f}
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="card p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p
                className={`text-sm font-semibold ${totalIncome - totalExpense >= 0 ? "text-emerald-400" : "text-red-400"}`}
              >
              ...
              <div className="card overflow-hidden divide-y divide-slate-800/50">
                {txList.map((tx) => (
                  ...
                  >
                    ...
                    <p
                      className={`text-sm font-semibold shrink-0 ${tx.type === "income" ? "text-emerald-400" : "text-red-400"}`}
                    >
                      {tx.type === "income" ? "+" : "−"}
          ...
          >
            <div className="p-6 space-y-4">
              ...
              <p className="text-sm text-slate-400">
                ...
                — {formatCurrency(confirmDelete.amount)} will be permanently
                removed.
              </p>
